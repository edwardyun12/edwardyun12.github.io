...
export const AwsIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" aria-hidden="true">
    <path d="M3 15.5c6 3.6 12 3.6 18 0" stroke="currentColor" strokeWidth={2} strokeLinecap="round" />
    <path
      d="M18.2 14.4c1.4.2 2.7.7 3.8 1.4-.1 1.2-.5 2.8-1.2 3.9-.15-1.3-.35-2.9-.6-3.9-1-.2-2.4-.6-3.6-1a.3.3 0 0 1 .1-.4c.5-.1 1-.1 1.5 0Z"
      fill="currentColor"
    />
  </svg>
)
